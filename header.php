...
<html class="no-js" <?php language_attributes(); ?>>
	...
	<script id="mcjs">!function(c,h,i,m,p){m=c.createElement(h),p=c.getElementsByTagName(h)[0],m.async=1,m.src=i,p.parentNode.insertBefore(m,p)}(document,"script","https://chimpstatic.com/mcjs-connected/js/users/c3645357b8ddbb2d38d1c3fc7/12f61193715eb06437f211849.js");</script>

	</head>
	
	<script src="https://cdn.websitepolicies.io/lib/cookieconsent/1.0.3/cookieconsent.min.js" defer></script><script>window.addEventListener("load",function(){window.wpcc.init({"border":"thin","colors":{"popup":{"background":"#f6f6f6","text":"#000000","border":"#222222"},"button":{"background":"#222222","text":"#ffffff"}},"position":"bottom","margin":"large","fontsize":"small","content":{"href":"https://fotimnafilm.sk/cookies/","message":"Tento web používa súbory cookies. Prehliadaním webu vyjadruješ súhlas s ich používaním. ","link":"Viac informácií","button":"OK"}})});</script>
